...
class BaseTFRecordsDataset(Dataset):
    ...
    @classmethod
    def _get_train_val_test_indices(cls):
        ...
        indices = list(range(len(cls.tfr_sample_names)))
    ...
    def _get_tfr_sample_names(cls):
        zip_dir = cls.cfg.preprocessing.dataset.zip_path
        all_files_list = []
...
class TFRecordsDataset(BaseTFRecordsDataset):
...
class TFRecordsPartialDataset(BaseTFRecordsDataset):
